    ...
    <form @submit.prevent="tryRegister" class="h-full w-full">
      <div class="flex h-full flex-col">
        ...
        <a
          ...
          type="button"
          class="ml-14 mt-4 mr-14 mb-2 inline-flex items-center rounded-lg bg-[#050708] px-5 py-2.5 text-center text-sm font-medium text-white hover:bg-[#050708]/90 focus:outline-none focus:ring-4 focus:ring-[#050708]/50 dark:hover:bg-[#050708]/30 dark:focus:ring-[#050708]/50"
        >
          <img class="mr-2" width="24" src="../../assets/discord.png" alt="logo discord">
          &nbsp Contactez nous sur discord
        </a>
      </div>
    </form>
  </AuthView>
